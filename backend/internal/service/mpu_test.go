...
func (f *fakeMPUStorage) GenerateStagingUploadURL(_ context.Context, stagingKey string, _ time.Duration) (string, error) {
	return "https://s3.example.com/" + stagingKey, nil
}

func (f *fakeMPUStorage) PromoteObject(_ context.Context, _, _ string) error { return nil }
