...
type BlockRepository interface {
	...
	// ReplaceBlocksForFile replaces all existing file_blocks for a file with a new sequence.
	ReplaceBlocksForFile(ctx context.Context, fileID string, blockIDsWithSeq []BlockSequence) error
